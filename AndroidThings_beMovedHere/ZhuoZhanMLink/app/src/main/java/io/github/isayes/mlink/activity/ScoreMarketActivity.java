...
public class ScoreMarketActivity extends AppCompatActivity {
    ...
    private void getToolbar() {
        ...
        pageTitle.setText("积分商城");
    }


    private void showToast(String msg) {
        Toast toast = Toast.makeText(ScoreMarketActivity.this, msg, Toast.LENGTH_SHORT);
