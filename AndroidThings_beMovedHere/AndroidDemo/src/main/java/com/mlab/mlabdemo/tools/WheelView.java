...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = WheelViewConfig.VALUE_TEXT_COLOR;//0xF0FF0000;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = WheelViewConfig.ITEMS_TEXT_COLOR;//0xFF00FF00;
...
//        setBackgroundResource(R.drawable.wheel_bg);
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            //float textWidth = FloatMath.ceil(Layout.getDesiredWidth("0", itemsPaint));//FloatMath已经被废弃不能使用了,改成Math
    ...
    private Handler animationHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            Log.i("ljw", "curry:" + currY + "; " + scroller.getFinalY() + "" + MIN_DELTA_FOR_SCROLLING);
